...
export default class WebSocketClass {
   ...
   */
  public url: string;
  public msgCallback: (e) => void;
  public name: string;
  public ws: any;
  public status: any;
  public pingPong: string | boolean;
  public onerror;
  public pongInterval: any;
  public pingInterval: any;

  constructor(url: string, msgCallback: (e) => void, name: string = "default") {
    this.url = url;
